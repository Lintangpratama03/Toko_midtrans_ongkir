                                    ...
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="{{route('product-detail',$product->slug)}}">
                                                ...
                                                // dd($photo);
                                                @endphp
                                                <img class="default-img" src="{{$photo[0]}}" alt="{{$photo[0]}}" style="width: 100px; height:100px">
                                            ...
                                            <div class="button-head">
                                                <div class="product-action">
                                                    ...
                                                    <a title="Wishlist" href="{{route('add-to-wishlist',$product->slug)}}" ><i class=" ti-heart "></i><span>Masukkan ke Wishlist</span></a>
                                                </div>
                ...
                @foreach($featured as $data)
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="single-banner">
                            ...
                            @endphp
                            <img src="{{$photo[0]}}" alt="{{$photo[0]}}" style="opacity: 0.2;">
                            <div class="content">
                        ...
                        <div class="single-product">
                            <div class="product-img">
                                ...
                                <div class="button-head">
                                    <div class="product-action">
                                        <!-- <a data-toggle="modal" data-target="#{{$product->id}}" title="Quick View" href="#"><i class=" ti-eye"></i><span>Quick Shop</span></a> -->
                                        <a title="Wishlist" href="{{route('add-to-wishlist',$product->slug)}}" ><i class=" ti-heart "></i><span>Masukkan Wishlist</span></a>
                                    </div>
                                    <div class="product-action-2">
                            ...
                            <div class="single-list">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 no-padding">
                                    <div class="content">
                                        ...
                                        <p class="price with-discount">Diskon {{number_format($product->discount,0)}}%</p>
                                    </div>
                                </div>
                                </div>
                            </div>
