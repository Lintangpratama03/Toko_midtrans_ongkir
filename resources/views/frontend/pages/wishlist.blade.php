							...
							@if(Helper::getAllProductFromWishlist())
								@foreach(Helper::getAllProductFromWishlist() as $key=>$wishlist)
									<tr>
										...
										<td><a href="{{route('add-to-cart',$wishlist->product['slug'])}}" class='btn text-white'>+ Keranjang</a></td>
							...
							@else 
								<tr>
									<td class="text-center">
										Tidak ada Produk di Wishlist anda. <a href="{{route('product-grids')}}" style="color:blue;">Lanjutkan belanja</a>
