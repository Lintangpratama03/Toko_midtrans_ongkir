...
@section('title','Toko Andrimas || PRODUCT PAGE')
					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="javascript:void(0);">Produk List Kategori</a></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="col-lg-3 col-md-4 col-12">
							<div class="shop-sidebar">
                                ...
                                <div class="single-widget recent-post">
                                    <h3 class="title">Baru Diupload</h3>
                                    {{-- {{dd($recent_products)}} --}}
														...
														<div class="product-img">
															...
															<div class="button-head">
																<div class="product-action">
																	...
																	<a title="Wishlist" href="{{route('add-to-wishlist',$product->slug)}}" class="wishlist" data-id="{{$product->id}}"><i class=" ti-heart "></i><span>Masukkan ke Wishlist</span></a>
																</div>
