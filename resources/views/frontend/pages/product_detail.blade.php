...
@endsection
@section('title','Toko Andrimas || DETAIL PRODUK')
															...
															<div class="col-12">
																...
																<div class="comment-review">
																	<div class="add-review">
																		...
																		<p>Email tidak akan di publsh. Tanda (*) merupakan yang wajib diisi.</p>
																	</div>
																...
																<div class="ratting-main">
																	<div class="avg-ratting">
																		...
																		@endphp --}}
																		<h4>{{ceil($product_detail->getReview->avg('rate'))}} <span>(Total)</span></h4>
